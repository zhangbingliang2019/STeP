...
class UNetSpatioTemporalConditionModelCustom(ModelMixin, ConfigMixin, UNet2DConditionLoadersMixin):
    r"""
...
class UNetSpatioTemporalDiffusion(UNetSpatioTemporalConditionModelCustom):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)

    def forward(self, sample, timestep, image_only_indicator=None):
        if image_only_indicator is None:
            image_only_indicator = torch.zeros(sample.shape[0:2], dtype=torch.bool, device=sample.device)
