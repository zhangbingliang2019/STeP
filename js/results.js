var bhvr_items = [
    {
        steps: [
            ...
            { video: "000003/IDM+BCS.mp4", label: "Baseline (based on image diffusion)" },
        ]
    },
    {
        steps: [
            ...
            { video: "000012/IDM+BCS.mp4", label: "Baseline (based on image diffusion)" },
        ]
    },
    {
        steps: [
            ...
            { video: "000046/IDM+BCS.mp4", label: "Baseline (based on image diffusion)" },
        ]
    },
    {
        steps: [
            ...
            { video: "000053/IDM+BCS.mp4", label: "Baseline (based on image diffusion)" },
        ]
    },
    {
        steps: [
            ...
            { video: "000067/IDM+BCS.mp4", label: "Baseline (based on image diffusion)" },
        ]
    },
    {
        steps: [
            ...
            { video: "000072/IDM+BCS.mp4", label: "Baseline (based on image diffusion)" },
        ]
    },
];
...
var dmri_items = [
    ...
    },
    {
        steps: [
            ...
            { video: "000016/IDM+BCS.mp4", label: "Baseline (based on image diffusion)" },
        ]
    },
    {
        steps: [
            ...
            { video: "000007/IDM+BCS.mp4", label: "Baseline (based on image diffusion)" },
        ]
    },
    {
        steps: [
            ...
            { video: "000011/IDM+BCS.mp4", label: "Baseline (based on image diffusion)" },
        ]
    },
    {
        steps: [
            ...
            { video: "000009/IDM+BCS.mp4", label: "Baseline (based on image diffusion)" },
        ]
    },
    {
        steps: [
            ...
            { video: "000013/IDM+BCS.mp4", label: "Baseline (based on image diffusion)" },
        ]
    },
];
